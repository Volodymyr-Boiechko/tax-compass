...
Finland has a dual income tax system: **earned income** (employment, business, self-employment wages) subject to progressive national + municipal + church + YLE taxes; **capital income** (interest, dividends, capital gains, rental, business capital portion) subject to flat capital income tax. Tax year = calendar year. Pre-filled returns sent each spring; corrections due within specified time limit. Married persons taxed separately. (EY p.418, p.424)
...
- Capital gains on all assets in year: exempt if total sales price ≤EUR 1,000 (acquisition costs excluded). (EY p.420)

**Dividends (Finnish residents):**
- Listed company in tax treaty country: 85% of dividend = taxable capital income; 15% exempt.
- Unlisted companies: may be exempt, capital income, or earned income depending on company net assets and country of residence. (EY p.419)
...
|---|---|---|---|
| Medicare per diem | 0.84% | — | 1.04% of pensionable income |
| Medicare (municipal) | 1.06% | — | same |
| Medicare additional (earned income > per diem base) | 1.45% | — | — |
| Compulsory pension (TyEL) | 7.15% | ~17.38% avg | 24.1% (≤52 yrs) / 25.6% (53–62 yrs) |
| Unemployment insurance | 0.59% | 0.20% (salaries ≤EUR 2,455,000) / 0.80% (excess) | not required |
| **Total approx. employee** | **~9.64%** | **~20.65%** | **varies** |

**Self-employed pension (YEL — Entrepreneur Pension Act):** (EY p.423–424)
- Self-employed individuals insured under YEL pay social security contributions consisting of Medicare + per diem contributions (same as employees) plus pension insurance at:
  - 24.1% for individuals ≤52 years old
  - 25.6% for individuals who are >52 years and ≤62 years old
  - Starting entrepreneurs: 18.8% and 19.97% respectively (reduced rates)
- Self-employed under YEL do NOT need compulsory unemployment, accident or group life insurance. (EY p.424)
- YEL base = annual "pensionable salary" agreed between entrepreneur and pension institution.

**Notes:**
- Total employer SS average ~20.65% for private sector. (EY p.424)
- For assignments to Finland from outside EU/EEA/Switzerland/totalization countries: employees generally exempt from pension insurance for initial two years. (EY p.424)
- Totalization agreements (bilateral): Australia, Canada, Chile, China Mainland, India, Israel, Japan, Korea (South), Quebec, United States. (EY p.424)
...
- **Who qualifies:** Individual taxpayers with business income (net business income from sole proprietorship).
- **Tax base:** Net business income minus 5% entrepreneur deduction.
- **Rate / mechanism:** 5% of net business income is deductible before applying earned/capital income split and tax rates.
- **Social security:** Same as Option A.
- **Key limits:** Applies automatically to qualifying business income; reduces effective tax rate. (EY p.419)
...
> Single person, no dependants, no church membership (no church tax), no dependent deductions.
...
|---|---|---|
| Employee SS (~9.64%) | 9.64% × 30,000 | EUR 2,892 |
| YLE tax (2.5% on >EUR 15,150, cap EUR 160) | 2.5% × (30,000 − 15,150) = 371, capped | EUR 160 |
| PIT base (after EUR 750 std deduction) | 30,000 − 750 | EUR 29,250 |
| National income tax on EUR 29,250: | | |
| — Band 1: EUR 0–21,200 at 12.64% | 12.64% × 21,200 | EUR 2,680 |
| — Band 2: EUR 21,200–29,250 at 19% | 19% × 8,050 | EUR 1,530 |
| National income tax | 2,680 + 1,530 | EUR 4,210 |
| Municipal tax (8% avg) | 8% × 29,250 | EUR 2,340 |
| Total income taxes + YLE | 4,210 + 2,340 + 160 | EUR 6,710 |
| **Total burden** | **2,892 + 6,710** | **EUR 9,602** |
| **Effective rate** | **9,602 / 30,000** | **~32.0%** |

### Working: €30,000 B2B Sole Trader (entrepreneur deduction 5%, YEL pension 24.1%)

| Step | Calculation | Result |
|---|---|---|
| YEL pension (24.1%, assumed on full revenue) | 24.1% × 30,000 | EUR 7,230 |
| Entrepreneur deduction (5%) | 5% × 30,000 | EUR 1,500 |
| Earned income base | 30,000 − 1,500 | EUR 28,500 |
| National income tax on EUR 28,500: | | |
| — Band 1: EUR 0–21,200 at 12.64% | EUR 2,680 | |
| — Band 2: EUR 21,200–28,500 at 19% | 19% × 7,300 | EUR 1,387 |
| National income tax | 2,680 + 1,387 | EUR 4,067 |
| Municipal tax (8%) | 8% × 28,500 | EUR 2,280 |
| YLE tax | EUR 160 | EUR 160 |
| Total income taxes + YLE | 4,067 + 2,280 + 160 | EUR 6,507 |
...
| Gross income | Scenario | Income tax + YLE | Social security | Total burden | **Effective rate** |
|---|---|---|---|---|---|
...
- Standard salary deduction EUR 750 for employment; entrepreneur deduction 5% for B2B
- YEL pension: 24.1% on gross income (conservative; actual base is agreed pensionable salary which may differ)
- No capital income split modeled for B2B (full earned income treatment)
- Travel expenses, union fees, and other deductions not modeled
...
- [ ] Municipal tax rate used (8% average); actual rate varies by municipality — Helsinki is 9.0%, some rural municipalities up to 10.9%
- [ ] Church tax not modeled (1%–2.25%); would add to effective rate for church members (~70% of Finns)
- [ ] YEL pensionable salary is agreed between entrepreneur and pension institution; may differ from gross revenue
- [ ] Capital income split for business income (10%/20% return on business assets) not modeled; actual self-employed effective rates may differ
